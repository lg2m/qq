...
const MODELS: &[ModelDefinition] = &[
    ...
    model! { catalogs: OPENAI_CODEX, wire: "gpt-5.5", canonical: "openai/gpt-5.5", name: "GPT-5.5", reasoning: true, limits: 272_000 / 128_000, pricing: None },
    model! { catalogs: OPENAI_CODEX, wire: "gpt-5.4", canonical: "openai/gpt-5.4", name: "GPT-5.4", reasoning: true, limits: 272_000 / 128_000, pricing: None },
    model! { catalogs: OPENAI_CODEX, wire: "gpt-5.4-mini", canonical: "openai/gpt-5.4-mini", name: "GPT-5.4 Mini", reasoning: true, limits: 272_000 / 128_000, pricing: None },
